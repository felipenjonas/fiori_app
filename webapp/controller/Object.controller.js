sap.ui.define([
    ...
    return BaseController.extend("categories.controller.Object", {
        ...
        onCriar: function () {
            ...
            // Nossa API de teste Odata, não aceita request em batch, por isso desativamos(pois é ativa por padrão na UI5) 
        ...
        onSalvar: function () {
            ...
            //atualização de uma entrada (update) https://sapui5.hana.ondemand.com/#/api/sap.ui.model.odata.v2.ODataModel%23methods/update
            var sId = this.getModel("objectModel").getProperty("/idValue");
            var sName = this.getModel("objectModel").getProperty("/nameValue");
            var sMsgSucesso = this.getView().getModel("i18n").getResourceBundle().getText("msgSuccess");
